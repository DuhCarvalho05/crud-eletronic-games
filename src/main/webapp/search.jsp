	...
	<div class="row justify-content-between">
					...
					<ul style="list-style: none; padding: 0; margin: 0">
						<c:forEach var="category" items="${ categories }">
							<li style="margin-bottom: 10px;" class="category-link d-flex">
								...
								href="${pageContext.request.contextPath}/catalog/${ category.name }">
									${ category.name } </a>
							</li>
						</c:forEach>
					</ul>
		...
		<div class="col-9">
			<c:choose>
				...
				<c:otherwise>
					<span class="fw-bold text-capitalize">Resultado da pesquisa: ${ query }</span>
						...
						<c:forEach var="game" items="${ games }">
							<div>
								<div style="border: 1px solid #27272a;"
									...
									<a class="d-flex w-100 p-2"
										href="${pageContext.request.contextPath}/details/${ game.id }">
										<img style="opacity: 0.8;" class="w-100 rounded"
