...
<div class="container">
	...
	<div class="w-100 d-flex justify-content-end mb-3">
		<a class="btn btn-light btn-sm"
			href="${pageContext.request.contextPath}/register-category"> <svg
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center gap-2">
									<a
										href="${pageContext.request.contextPath}/update-category/${category.id}">
										...
										href="${pageContext.request.contextPath}/delete-category/${category.id}">
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
